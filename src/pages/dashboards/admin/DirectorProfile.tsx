...
import { 
  ...
  Building, Calendar, Users, Award, Camera, Edit, BookOpen, GraduationCap, Globe
} from 'lucide-react';
...
const DirectorProfile: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    name: user?.name || 'Dr. Casey Kim',
    email: user?.email || 'casey.kim@example.com',
    currentPassword: '',
    newPassword: '',
    confirmPassword: '',
    theme: theme,
    institution: 'Campus Events University',
    designation: 'Director',
    specialization: 'Educational Administration & Strategic Planning',
    experience: '25 years',
    phone: '+1 (555) 123-4571',
    office: 'Director Office, Administrative Building',
    qualification: 'Ph.D. in Educational Leadership, MBA in Strategic Management',
    collegeCount: '5',
    totalFaculty: '428',
    totalStudents: '12450',
    institutionBudget: '$15M',
    partnerships: '45'
  });
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Manage your director information and institutional overview</p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-600">Director</p>
              <p className="text-sm text-primary-600">{profileData.institution}</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.collegeCount}</span>
                  {isEditing && (
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.totalFaculty}</span>
                  {isEditing && (
                    <Edit size={12} className="text-neutral-400" />
                  )}
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.totalStudents}</span>
                  {isEditing && (
                    <Edit size={12} className="text-neutral-400" />
                  )}
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.partnerships}</span>
                  {isEditing && (
                    <Edit size={12} className="text-neutral-400" />
                  )}
                </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="border-t border-neutral-200 pt-6">
                <h3 className="text-md font-semibold mb-4 text-neutral-800">Institutional Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">
                      Institution
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      name="collegeCount"
                      value={profileData.collegeCount}
                      onChange={handleInputChange}
                      className="input"
                      disabled={!isEditing}
                      min="1"
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      name="totalFaculty"
                      value={profileData.totalFaculty}
                      onChange={handleInputChange}
                      className="input"
                      disabled={!isEditing}
                      min="1"
