...
import { 
  ...
  Building, Calendar, Users, Award, Camera, Edit, BookOpen, GraduationCap, DollarSign
} from 'lucide-react';
...
const DeanProfile: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    name: user?.name || 'Dr. Jordan Chen',
    email: user?.email || 'jordan.chen@example.com',
    currentPassword: '',
    newPassword: '',
    confirmPassword: '',
    theme: theme,
    ...
    designation: 'Dean',
    specialization: 'Educational Leadership & Engineering Management',
    experience: '20 years',
    phone: '+1 (555) 123-4570',
    office: 'Dean Office, Main Building',
    qualification: 'Ph.D. in Engineering Management, M.Tech in Computer Science',
    departmentCount: '6',
    facultyCount: '86',
    studentCount: '2450',
    collegeBudget: '$2.5M'
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Manage your dean information and college overview</p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-600">Dean</p>
              <p className="text-sm text-primary-600">{profileData.college}</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.departmentCount}</span>
                  {isEditing && (
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.facultyCount}</span>
                  {isEditing && (
                    <Edit size={12} className="text-neutral-400" />
                  )}
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <div className="flex items-center">
                  <span className="font-medium mr-2">{profileData.studentCount}</span>
                  {isEditing && (
                    <Edit size={12} className="text-neutral-400" />
                  )}
                </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="border-t border-neutral-200 pt-6">
                <h3 className="text-md font-semibold mb-4 text-neutral-800">College Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">
                      College
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={profileData.departmentCount}
                      onChange={handleInputChange}
                      className="input"
                      disabled={!isEditing}
                      min="1"
