  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Manage your department head information and preferences</p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-600">Head of Department</p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                ...
                <span className="font-medium">{profileData.clubsInDept}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                <div className="flex items-center">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="border-t border-neutral-200 pt-6">
                <h3 className="text-md font-semibold mb-4 text-neutral-800">Department Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-neutral-700 mb-2">
                      Department
