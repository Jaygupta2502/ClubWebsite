...
useEffect(() => {
 ...
 // 👈 Trigger refetch on toggle
  ...
  // Filter events based on search query, selected categories, and date range
  const filteredEvents = events.filter((event) => {
    ...
    // For demo purposes, we're assuming all events match the date range
